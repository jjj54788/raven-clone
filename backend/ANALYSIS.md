...
- `POST /api/v1/chatkit/session` (backend/src/modules/chatkit/chatkit.controller.ts)
- `GET  /api/v1/chatkit/status` (backend/src/modules/chatkit/chatkit.controller.ts)
...
src/modules/chatkit/
src/modules/chatkit/chatkit.controller.ts
src/modules/chatkit/chatkit.module.ts
src/modules/chatkit/chatkit.service.ts
src/modules/checkin/
